...
active_repeat = False
active_change = False
user_input_font = pygame.font.Font(None, 32)
...
while True:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            active_d = func.collision_for_rect(user_input_rect_d.collidepoint(event.pos))
        ...
        if event.type == pygame.KEYDOWN:
            if active_r:
                ...
                user_input_n = func.write_or_delete_in_text_container(user_input_n, event.key, event.unicode)
            elif active_d:
    ...
    color_n = func.is_active(active_n)
    ...
    pygame.draw.rect(window, color_n, user_input_rect_n, 2)
    ...
    text_surface_eta = user_input_font.render(user_input_eta, True, (255, 255, 255))
    ...
    window.blit(text_surface_d_info, (100, 240))
    ...
    window.blit(text_surface_r, (user_input_rect_r.x + 5, user_input_rect_r.y + 5))
    ...
    user_input_rect_d.w = max(40, text_surface_d.get_width() + 10)
